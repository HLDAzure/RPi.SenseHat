            ...
            try
            {
                ...
                */
                ...
                foreach (JsonValue oJsonVal in anjarray)
                {
                    ...
                    SettingInfo oContent = new SettingInfo();
                    oContent.keyName = oJsonObj.GetNamedValue("keyName").GetString();
                    oContent.keyValue = oJsonObj.GetNamedValue("keyValue").GetString();
